...
width=30;% — Ancho del mapa (escalar en metros)
height=30;% — Altura del mapa (escalar en metros)
resolution=20; % — Resolución de cuadrícula (1 (predeterminado) | escalar en celdas por metro)
